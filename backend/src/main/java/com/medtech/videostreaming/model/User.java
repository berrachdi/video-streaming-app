package com.medtech.videostreaming.model;
...
public class User {
    ...
    public boolean isSubscrubedTo(String userid) {
        return this.subscribedToUsers.stream().anyMatch(subscriber->subscriber.equals(userid));
    }
}
